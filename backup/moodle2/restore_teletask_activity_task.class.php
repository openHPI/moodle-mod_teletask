...
/**
 * 
 * Defines restore_teletask_activity_task
 * 
...
class restore_teletask_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // The teletask only has one structure step.
        $this->add_step(new restore_teletask_activity_structure_step('teletask', 'teletask.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('teletask', array('description'), 'teletask');
